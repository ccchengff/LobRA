...
if [ -z ${CONFIGURATION_PROPOSAL} ] || [ ${CONFIGURATION_PROPOSAL} = "TRUE" ]; then
    export STRATEGY_PROPOSAL=1
elif [ ${CONFIGURATION_PROPOSAL} = "FALSE" ]; then
    export STRATEGY_PROPOSAL=0
else 
    echo "CONFIGURATION_PROPOSAL should be TRUE or FALSE"
    exit -1
fi
